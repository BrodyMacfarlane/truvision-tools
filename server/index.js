...
app.post('/api/getShortLink', (req, res) => {
  let encodedURL = `https://shop.truvisionhealth.com/${req.body.username}/Login?type=2&countrycode=${req.body.countryCode}&language=${req.body.languagePref ? req.body.languagePref : "en"}-${req.body.countryCode.toUpperCase()}&products=${JSON.stringify(req.body.cart)}`
